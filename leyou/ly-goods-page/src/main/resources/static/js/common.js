...
const stringify = function( // eslint-disable-line func-name-matching
    object,
    prefix,
    generateArrayPrefix,
    strictNullHandling,
    ...
    formatter,
    encodeValuesOnly) {
    formatter = formatter || utils.formatter;
    generateArrayPrefix = generateArrayPrefix || utils.generateArrayPrefix;
    prefix = prefix || "";
    encodeValuesOnly = encodeValuesOnly == null ? true : encodeValuesOnly;
    encoder = encoder || utils.encode;
    allowDots = allowDots || true;
    var obj = object;
    ...
    if (typeof obj === 'string' || typeof obj === 'number' || typeof obj === 'boolean' || utils.isBuffer(obj)) {
        if (encoder) {
            ...
            return [keyValue.substring(1) + '=' + formatter(encoder(obj, utils.encoder))];
        }
